---
description: "First Audit Phase 1: Setup Architecture Analysis"
mode: subagent
temperature: 0.1
---

# Phase 1: Analyze Contracts and Output Setup Decisions
...
## Objective
Analyze the codebase and output `magic/setup-decisions.json` containing your decisions about how Invariant Testing should be configured.
...
## Files to Analyze
1. `src/**/*.sol` - Source contracts being tested
2. `test/*.sol` - Existing tests for deployment patterns
3. `memory/artifacts/system_model.md` - Validated system model, to understand how the system works
4. `memory/code_intel_memory.md` - Notes tied to understanding how the system works.
